//Author: Jack Ambery
// Extra Credit: Chapter 6 Question 23
// 29 October 2019
    ...
    implements ActionListener
{
 ...
 private int nextPlay(char computerMove, char playerMove) {
      ...
      switch (result) {
      case (computerMove == 'R') && (playerMove == 'S'):
      case (computerMove == 'S') && (playerMove == 'P'):
      case (computerMove == 'P') && (playerMove == 'R'):
         result = 1;
         break;
      case (playerMove == 'R') && (computerMove == 'S'):
      case (playerMove == 'P') && (computerMove == 'R'):
      case (playerMove == 'S') && (computerMove == 'P'):
         result = -1;
         break;
      case (playerMove == 'R') && (computerMove == 'R'):
      case (playerMove == 'P') && (computerMove == 'P'):
      case (playerMove == 'S') && (computerMove == 'S'):
         result = 0;
         break;
      }
    return result;
