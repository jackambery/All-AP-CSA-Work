//Name: Jack Ambery
//Assignment: Ch. 10 Ex. 6 Subtract and Divide Fractions
...
public class Fraction {
   ...
   public Fraction subtract(Fraction other) {
      ...
      other.denom *= denom;
      num *= other.denom;
      denom *= other.denom; //fractions now have equal denomenators
   ...
   public Fraction divide(Fraction other) {
      ...
      if ((double)newNum / newDenom == 0) {
         throw new IllegalArgumentException(
            "You can not divide by a zero fraction");
      }
      
      else {
         return new Fraction(num * newDenom, denom * newNum);
      }
   }
